...
Route::post('orders/delete', '\app\index\controller\Orders@delete')->middleware(\app\index\middleware\AuthCheck::class)->middleware(\app\middleware\VerifyCsrf::class);
Route::get('orders/supplement', '\app\index\controller\Orders@supplementRedirect')->middleware(\app\index\middleware\AuthCheck::class);
